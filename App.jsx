    ...
    body: JSON.stringify({
      ...
      messages: [{
        ...
        content: [
          ...
          { type: "text", text: `Você é um leitor especializado em ordens de serviço de joalheria. Analise esta foto de uma OS da Garimpo Jóias e extraia os campos. Retorne SOMENTE um JSON válido, sem texto adicional, sem markdown: {"numero":"número da OS","cliente":"nome do cliente","fone":"telefone","descricao":"descrição do serviço","recepcao":"nome de quem recepcionou","data":"data no formato DD/MM/AAAA","ac":"valor A/C apenas números e vírgula ex: 300,00","nc":"valor N/C se houver senão string vazia","obs":"observações se houver senão string vazia"}` }
        ]
      }]
    })
  });
